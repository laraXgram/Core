...
use LaraGram\Database\Eloquent\Attributes\UseResource;
use LaraGram\Database\Eloquent\Attributes\UseResourceCollection;
use LaraGram\Database\Eloquent\Model;
use LaraGram\Http\Resources\Json\ResourceCollection;
use LogicException;
use ReflectionClass;
...
trait TransformsToResourceCollection
{
     ...
     *
     * @param  class-string<\LaraGram\Http\Resources\Json\JsonResource>|null  $resourceClass
     * @return \LaraGram\Http\Resources\Json\ResourceCollection
     *
     * @throws \Throwable
     */
     ...
     *
     * @param  class-string<\LaraGram\Http\Resources\Json\JsonResource>  $class
     ...
     *
     * @param  class-string<\LaraGram\Http\Resources\Json\ResourceCollection>  $class
     * @return class-string<*>|null
     */
