...
class LazyCollection implements CanBeEscapedWhenCastToString, Enumerable
{
     ...
     *
     * @param  \LaraGram\Contracts\Support\Arrayable<TKey, TValue>|iterable<TKey, TValue>|(Closure(): \Generator<TKey, TValue, mixed, void>)|self<TKey, TValue>|array<TKey, TValue>|null  $items
     * @return static
     */
    ...
    {
        return class_exists(Tempora::class)
            ? Tempora::now()->getTimestamp()
            : time();
    }
    ...
    {
        return class_exists(Tempora::class)
            ? Tempora::now()->getPreciseTimestamp()
