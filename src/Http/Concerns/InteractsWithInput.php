...
namespace LaraGram\Http\Concerns;
...
trait InteractsWithInput
{
    ...
    {
        return $this->retrieveItem('http.request', $key, $default);
    }
     ...
     * @param  string|null  $key
     * @param  mixed  $default
     * @return ($key is null ? array<string, \LaraGram\Http\Files\UploadedFile|\LaraGram\Http\Files\UploadedFile[]> : \LaraGram\Http\Files\UploadedFile|\LaraGram\Http\Files\UploadedFile[]|null)
     */
