...
use LaraGram\Http\Resources\JsonApi\Exceptions\ResourceIdentificationException;
use LaraGram\Http\Resources\JsonApi\JsonApiRequest;
use LaraGram\Http\Resources\JsonApi\JsonApiResource;
use LaraGram\Http\Resources\JsonApi\RelationResolver;
use LaraGram\Http\Resources\MissingValue;
...
trait ResolvesJsonApiElements
{
     ...
     *
     * @var array<int, array{0: \LaraGram\Http\Resources\JsonApi\JsonApiResource, 1: string, 2: string, 3: bool}|null
     */
