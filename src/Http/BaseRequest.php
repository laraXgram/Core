...
use LaraGram\Http\Exceptions\BadRequestException;
use LaraGram\Http\Exceptions\ConflictingHeadersException;
use LaraGram\Http\Exceptions\SessionNotFoundException;
use LaraGram\Http\Exceptions\SuspiciousOperationException;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): static
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of LaraGram\Http\BaseRequest.');
            }
