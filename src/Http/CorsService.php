...
class CorsService
{
    ...
    /**
     * Create a pattern for a wildcard, based on Str::is() from LaraGram
     *
    ...
    public function isCorsRequest(BaseRequest $request): bool
    {
        return $request->headers->has('Origin');
    }

    public function isPreflightRequest(BaseRequest $request): bool
    {
        return $request->getMethod() === 'OPTIONS' && $request->headers->has('Access-Control-Request-Method');
    }

    public function handlePreflightRequest(BaseRequest $request): BaseResponse
    {
    ...
    public function addPreflightRequestHeaders(BaseResponse $response, BaseRequest $request): BaseResponse
    {
    ...
    public function isOriginAllowed(BaseRequest $request): bool
    {
    ...
    public function addActualRequestHeaders(BaseResponse $response, BaseRequest $request): BaseResponse
    {
        $this->configureAllowedOrigin($response, $request);
    ...
    private function configureAllowedOrigin(BaseResponse $response, BaseRequest $request): void
    {
    ...
    private function configureAllowedMethods(BaseResponse $response, BaseRequest $request): void
    {
    ...
    private function configureAllowedHeaders(BaseResponse $response, BaseRequest $request): void
    {
    ...
    private function configureAllowCredentials(BaseResponse $response, BaseRequest $request): void
    {
    ...
    private function configureExposedHeaders(BaseResponse $response, BaseRequest $request): void
    {
    ...
    private function configureMaxAge(BaseResponse $response, BaseRequest $request): void
    {
        if ($this->maxAge !== null) {
    ...
    public function varyHeader(BaseResponse $response, string $header): BaseResponse
    {
