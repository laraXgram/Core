...
use LaraGram\Session\SessionDecorator;
 ...
 */
class Request extends BaseRequest implements Arrayable, ArrayAccess
{
     ...
     *
     * @var \LaraGram\Http\InputBag|null
     */
    protected $json;
     ...
     *
     * @var array<int, \LaraGram\Http\Files\UploadedFile|\LaraGram\Http\Files\UploadedFile[]>
     */
     ...
     * @param  mixed  $default
     * @return ($key is null ? \LaraGram\Http\InputBag : mixed)
     */
    ...
    /**
     * Create a new request instance from the given LaraGram request.
     *
     * @param  \LaraGram\Http\Request  $from
     * @param  \LaraGram\Http\Request|null  $to
     * @return static
     */
    public static function createFrom(self $from, $to = null)
    {
        ...
        if ($from->hasSession() && $session = $from->session()) {
            $request->setLaraGramSession($session);
        }
     ...
     * {@inheritdoc}
     *
     * @throws \LaraGram\Http\Exceptions\SessionNotFoundException
     */
    #[\Override]
     ...
     * @return void
     */
    public function setLaraGramSession($session)
    {
     ...
     * @param  mixed  $default
     * @return ($param is null ? \LaraGram\Routing\Route : object|string|null)
     */
     ...
     *
     * @param  \LaraGram\Http\InputBag  $json
     * @return $this
     */
