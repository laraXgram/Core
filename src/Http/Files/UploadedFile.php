...
use LaraGram\Http\Files\Exceptions\CannotWriteFileException;
use LaraGram\Http\Files\Exceptions\ExtensionFileException;
use LaraGram\Http\Files\Exceptions\FileException;
use LaraGram\Http\Files\Exceptions\FileNotFoundException;
use LaraGram\Http\Files\Exceptions\FormSizeFileException;
use LaraGram\Http\Files\Exceptions\IniSizeFileException;
use LaraGram\Http\Files\Exceptions\NoFileException;
use LaraGram\Http\Files\Exceptions\NoTmpDirFileException;
use LaraGram\Http\Files\Exceptions\PartialFileException;
