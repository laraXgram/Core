...
use LaraGram\Http\Client\Core\BodySummarizer;
use LaraGram\Http\Client\Core\BodySummarizerInterface;
use LaraGram\Http\Factory\RequestInterface;
use LaraGram\Http\Factory\ResponseInterface;
use LaraGram\Http\Factory\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(
        ...
        $uri = \LaraGram\Http\Client\Core\PsrUtils::redactUserInfo($request->getUri());
