...
use LaraGram\Http\Client\Core\Exceptions\BadResponseException;
use LaraGram\Http\Client\Core\Exceptions\TooManyRedirectsException;
...
class RedirectMiddleware
{
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response): RequestInterface
    {
        ...
        return PsrUtils::modifyRequest($request, $modify);
    }
