...
use LaraGram\Http\Client\Core\Handler\CurlHandler;
use LaraGram\Http\Client\Core\Handler\CurlMultiHandler;
use LaraGram\Http\Client\Core\Handler\CurlShareHandleState;
use LaraGram\Http\Client\Core\Handler\CurlVersion;
use LaraGram\Http\Client\Core\Handler\Proxy;
use LaraGram\Http\Client\Core\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return PsrUtils::tryFopen('php://output', 'w');
    }
     ...
     *
     * @return callable(RequestInterface, array): \LaraGram\Http\Client\Promises\PromiseInterface Returns the best handler for the given system.
     *
    ...
    /**
     * @return (callable(RequestInterface, array): \LaraGram\Http\Client\Promises\PromiseInterface)|null
     */
    ...
    /**
     * @param (callable(RequestInterface, array): \LaraGram\Http\Client\Promises\PromiseInterface)|null $handler
     *
     * @return callable(RequestInterface, array): \LaraGram\Http\Client\Promises\PromiseInterface
     */
