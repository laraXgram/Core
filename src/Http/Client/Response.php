...
use ArrayAccess;
use LaraGram\Http\Client\Core\StreamWrapper;
...
/**
 * @mixin \LaraGram\Http\Factory\ResponseInterface
 */
class Response implements ArrayAccess, Stringable
{
     ...
     *
     * @var \LaraGram\Http\Factory\ResponseInterface
     */
    protected $response;
     ...
     * The request cookies.
     *
     * @var \LaraGram\Http\Client\Core\Cookie\CookieJar
     */
    public $cookies;
     ...
     *
     * @var \LaraGram\Http\Client\Core\TransferStats|null
     */
     ...
     *
     * @return \LaraGram\Http\Factory\UriInterface|null
     */
     ...
     *
     * @param  callable|(\Closure(\LaraGram\Http\Client\Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @return \LaraGram\Http\Client\Core\Cookie\CookieJar
     */
     ...
     *
     * @return \LaraGram\Http\Factory\ResponseInterface
     */
     ...
     *
     * @return \LaraGram\Http\Client\RequestException|null
     */
     ...
     *
     * @param  null|(\Closure(\LaraGram\Http\Client\Response, \LaraGram\Http\Client\RequestException): mixed)  $callback
     * @return $this
     *
     ...
     *
     * @param  int|(\Closure(int, \LaraGram\Http\Client\Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws \LaraGram\Http\Client\RequestException
     */
