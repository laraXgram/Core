...
namespace LaraGram\Cache\Limiters;
...
class ConcurrencyLimiter
{
     ...
     *
     * @var \LaraGram\Contracts\Cache\LockProvider
     */
    protected $store;
     ...
     *
     * @param  \LaraGram\Contracts\Cache\LockProvider  $store
     * @param  string  $name
     * @param  int  $maxLocks
     ...
     * @return mixed
     *
     * @throws \LaraGram\Cache\Limiters\LimiterTimeoutException
     * @throws \Throwable
     */
     ...
     *
     * @param  string  $id
     * @return \LaraGram\Contracts\Cache\Lock|false
     */
     ...
     * Release the lock.
     *
     * @param  \LaraGram\Contracts\Cache\Lock  $lock
     * @return void
     */
