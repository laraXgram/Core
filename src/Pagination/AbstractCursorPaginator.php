 ...
 *
 * @mixin \LaraGram\Support\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Htmlable, Stringable
{
     ...
     *
     * @var \LaraGram\Support\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \LaraGram\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \LaraGram\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \LaraGram\Pagination\Cursor|null
     */
     ...
     * @param  bool  $isNext
     * @return \LaraGram\Pagination\Cursor
     */
     ...
     * @param  \LaraGram\Pagination\Cursor|null  $default
     * @return \LaraGram\Pagination\Cursor|null
     */
     ...
     *
     * @return \LaraGram\Contracts\View\Factory
     */
     ...
     * @template TSetValue
     *
     * @param  \LaraGram\Support\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
