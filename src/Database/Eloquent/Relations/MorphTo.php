 ...
 *
 * @extends \LaraGram\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
 */
class MorphTo extends BelongsTo
{
     ...
     *
     * @var \LaraGram\Database\Eloquent\Collection<int, TDeclaringModel>
     */
    protected $models;
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Collection<int, TRelatedModel>  $models
     * @return void
     */
     ...
     *
     * @return \LaraGram\Database\Eloquent\Collection<int, TDeclaringModel>
     */
