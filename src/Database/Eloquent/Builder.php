...
{
    /** @use \LaraGram\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \LaraGram\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \LaraGram\Database\Eloquent\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\LaraGram\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\LaraGram\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\LaraGram\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     * @return ($id is (\LaraGram\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \LaraGram\Database\Eloquent\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \LaraGram\Database\Eloquent\ModelNotFoundException<TModel>
     ...
     *
     * @param  \LaraGram\Contracts\Support\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \LaraGram\Database\Eloquent\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\LaraGram\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \LaraGram\Database\Eloquent\Collection<int, TModel> : TModel)
     *
     * @throws \LaraGram\Database\Eloquent\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\LaraGram\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \LaraGram\Database\Eloquent\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \LaraGram\Database\Eloquent\Relations\Relation<\LaraGram\Database\Eloquent\Model, TModel, *>
     */
     ...
     *
     * @return \LaraGram\Support\LazyCollection<int, TModel>
     */
     ...
     * @return \LaraGram\Pagination\LengthAwarePaginator<int, TModel>
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \LaraGram\Pagination\Paginator<int, TModel>
     */
     ...
     * @return \LaraGram\Pagination\CursorPaginator<int, TModel>
     */
     ...
     * @param  int|null  $page
     * @param  \Closure|int|null  $total
     * @return \LaraGram\Pagination\TelegramLengthAwarePaginator<int, TModel>
     */
    public function telegramPaginate($perPage = null, $columns = ['*'], $key = 'page', $page = null, $total = null)
    {
     ...
     * @param  string  $key
     * @param  int|null  $page
     * @return \LaraGram\Pagination\TelegramPaginator<int, TModel>
     */
    public function simpleTelegramPaginate($perPage = null, $columns = ['*'], $key = 'page', $page = null)
    {
     ...
     *
     * @param  array<array-key, array|(\Closure(\LaraGram\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\LaraGram\Database\Eloquent\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     ...
     *
     * @template TModelNew of \LaraGram\Database\Eloquent\Model
     *
     ...
     *
     * @param  array|\LaraGram\Contracts\Database\Query\Expression  $columns
     * @return array
     */
