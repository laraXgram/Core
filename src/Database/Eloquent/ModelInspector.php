...
class ModelInspector
{
    ...
    public function inspect($model, $connection = null)
    {
        ...
        /** @var \LaraGram\Database\Eloquent\Model $model */
...
//            'policy' => $this->getPolicy($model),
     ...
     * @return \LaraGram\Support\Collection<int, array<string, mixed>>
     */
...
//    }
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Model  $model
     * @return class-string<\LaraGram\Database\Eloquent\Collection>
     */
     ...
     *
     * @param  TModel  $model
     * @return class-string<\LaraGram\Database\Eloquent\Builder<TModel>>
     */
     ...
     *
     * @param  string  $model
     * @return class-string<\LaraGram\Database\Eloquent\Model>
     *
     * @see \LaraGram\Console\GeneratorCommand
     */
