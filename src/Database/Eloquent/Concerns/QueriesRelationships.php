...
trait QueriesRelationships
{
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\LaraGram\Database\Eloquent\Builder<TRelatedModel>): mixed)|null  $callback
     * @return $this
     *
     ...
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\LaraGram\Database\Eloquent\Builder<*>): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\Relation<*, *, *>|string  $relation
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @param  (\Closure(\LaraGram\Database\Eloquent\Builder<*>|\LaraGram\Database\Eloquent\Relations\Relation<*, *, *>): mixed)|null  $callback
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @template TRelatedModel of \LaraGram\Database\Eloquent\Model
     *
     * @param  \LaraGram\Database\Eloquent\Relations\MorphTo<TRelatedModel, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\LaraGram\Database\Eloquent\Builder<TRelatedModel>, string): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\MorphTo<*, TDeclaringModel>  $relation
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @return $this
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  (\Closure(\LaraGram\Database\Eloquent\Builder<TRelatedModel>): mixed)|string|array|\LaraGram\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  \LaraGram\Database\Eloquent\Model|iterable<int, \LaraGram\Database\Eloquent\Model>|string|null  $model
     * @return $this
     *
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Relations\MorphTo<*, *>|string  $relation
     * @param  \LaraGram\Database\Eloquent\Model|iterable<int, \LaraGram\Database\Eloquent\Model>|string  $model
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Model|\LaraGram\Database\Eloquent\Collection<int, \LaraGram\Database\Eloquent\Model>  $related
     * @param  string|null  $relationshipName
     * @param  string  $boolean
     * @return $this
     *
     * @throws \InvalidArgumentException
     * @throws \LaraGram\Database\Eloquent\RelationNotFoundException
     */
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Model  $related
     * @param  string|null  $relationshipName
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \LaraGram\Database\Eloquent\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Builder<*>  $hasQuery
     * @param  \LaraGram\Database\Eloquent\Relations\Relation<*, *, *>  $relation
     * @param  string  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \LaraGram\Database\Eloquent\Builder<*>  $from
     * @return $this
     */
     ...
     *
     * @param  string  $relation
     * @return \LaraGram\Database\Eloquent\Relations\Relation<*, *, *>
     */
