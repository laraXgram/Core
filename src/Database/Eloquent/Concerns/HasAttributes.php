...
use LaraGram\Database\Eloquent\Attributes\Appends;
use LaraGram\Database\Eloquent\Attributes\DateFormat;
...
trait HasAttributes
{
     ...
     * @return mixed
     *
     * @throws \LaraGram\Database\LazyLoadingViolationException
     */
