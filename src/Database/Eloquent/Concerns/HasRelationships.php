...
use Closure;
use LaraGram\Database\ClassMorphViolationException;
use LaraGram\Database\Eloquent\Attributes\Initialize;
use LaraGram\Database\Eloquent\Attributes\Touches;
...
use LaraGram\Database\Eloquent\PendingHasThroughRelationship;
...
use LaraGram\Database\Eloquent\Relations\HasManyThrough;
use LaraGram\Database\Eloquent\Relations\HasOne;
use LaraGram\Database\Eloquent\Relations\HasOneThrough;
use LaraGram\Database\Eloquent\Relations\MorphMany;
use LaraGram\Database\Eloquent\Relations\MorphOne;
use LaraGram\Database\Eloquent\Relations\MorphTo;
use LaraGram\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
     ...
     * @return \LaraGram\Database\Eloquent\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     * @return \LaraGram\Database\Eloquent\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string|null  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\MorphOne<TRelatedModel, TDeclaringModel>
     */
     ...
     * @return \LaraGram\Database\Eloquent\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \LaraGram\Database\Eloquent\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $ownerKey
     * @return \LaraGram\Database\Eloquent\Relations\MorphTo<\LaraGram\Database\Eloquent\Model, $this>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \LaraGram\Database\Eloquent\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \LaraGram\Database\Eloquent\Model
     *
     * @param  string|\LaraGram\Database\Eloquent\Relations\HasMany<TIntermediateModel, covariant $this>|\LaraGram\Database\Eloquent\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \LaraGram\Database\Eloquent\PendingHasThroughRelationship<\LaraGram\Database\Eloquent\Model, $this>
     *     : (
     *          $relationship is \LaraGram\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>
     *          ? \LaraGram\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \LaraGram\Database\Eloquent\Relations\HasMany<TIntermediateModel, $this>>
     *          : \LaraGram\Database\Eloquent\PendingHasThroughRelationship<TIntermediateModel, $this, \LaraGram\Database\Eloquent\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \LaraGram\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \LaraGram\Database\Eloquent\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \LaraGram\Database\Eloquent\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @template TRelatedModel of \LaraGram\Database\Eloquent\Model
     * @template TPivotModel of \LaraGram\Database\Eloquent\Relations\Pivot = \LaraGram\Database\Eloquent\Relations\Pivot
     ...
     * @param  string|null  $relation
     * @return \LaraGram\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, $this, TPivotModel>
     */
     ...
     * @param  \LaraGram\Database\Eloquent\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\LaraGram\Database\Eloquent\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \LaraGram\Database\Eloquent\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \LaraGram\Database\Eloquent\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \LaraGram\Database\Eloquent\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \LaraGram\Database\Eloquent\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \LaraGram\Database\Eloquent\Model|null  $instance
     * @return string
     */
     ...
     * @return string
     *
     * @throws \LaraGram\Database\ClassMorphViolationException
     */
