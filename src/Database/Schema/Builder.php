...
class Builder
{
     ...
     *
     * @var \Closure(\LaraGram\Database\Connection, string, \Closure|null): \LaraGram\Database\Schema\Blueprint
     */
    protected $resolver;
     ...
     * @return \LaraGram\Database\Schema\Blueprint
     */
     ...
     *
     * @param  \Closure(\LaraGram\Database\Connection, string, \Closure|null): \LaraGram\Database\Schema\Blueprint  $resolver
     * @return void
     */
