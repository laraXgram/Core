...
class BlueprintState
{
     ...
     *
     * @var \LaraGram\Database\Schema\Blueprint
     */
    protected $blueprint;
     ...
     * The primary key.
     *
     * @var \LaraGram\Database\Schema\IndexDefinition|null
     */
    private $primaryKey;
     ...
     * The indexes.
     *
     * @var \LaraGram\Database\Schema\IndexDefinition[]
     */
    private $indexes;
     ...
     * The foreign keys.
     *
     * @var \LaraGram\Database\Schema\ForeignKeyDefinition[]
     */
    private $foreignKeys;
     ...
     * Get the primary key.
     *
     * @return \LaraGram\Database\Schema\IndexDefinition|null
     */
