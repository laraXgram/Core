...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \LaraGram\Database\Schema\Blueprint  $blueprint
     * @param  \LaraGram\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     * @param  \LaraGram\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \LaraGram\Support\Fluent|null
     */
     ...
     *
     * @param  \LaraGram\Support\Fluent|\LaraGram\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
