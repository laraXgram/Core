...
use LaraGram\Database\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \LaraGram\Database\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
     ...
     *
     * @param  \LaraGram\Support\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \LaraGram\Support\Fluent|null  $primary
     * @return string|null
     */
