...
use LaraGram\Database\Events\StatementPrepared;
use LaraGram\Database\Events\TransactionBeginning;
use LaraGram\Database\Events\TransactionCommitted;
use LaraGram\Database\Events\TransactionCommitting;
use LaraGram\Database\Events\TransactionRolledBack;
use LaraGram\Database\Query\Builder as QueryBuilder;
use LaraGram\Database\Query\Expression;
use LaraGram\Database\Query\Grammars\Grammar as QueryGrammar;
use LaraGram\Database\Query\Processors\Processor;
use LaraGram\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \LaraGram\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @return \LaraGram\Database\Schema\Grammars\Grammar|null
     */
     ...
     * @return mixed
     *
     * @throws \LaraGram\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \LaraGram\Database\QueryException
     */
     ...
     *
     * @param  \LaraGram\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \LaraGram\Database\LostConnectionException
     */
     ...
     *
     * @param  \LaraGram\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \LaraGram\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \LaraGram\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
