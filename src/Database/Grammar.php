...
abstract class Grammar
{
     ...
     *
     * @param  array<\LaraGram\Contracts\Database\Query\Expression|string>  $values
     * @return array<string>
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string|int|float  $expression
