...
namespace LaraGram\Database\Capsule;

use LaraGram\Container\Container;
use LaraGram\Contracts\Events\Dispatcher;
use LaraGram\Database\Connectors\ConnectionFactory;
use LaraGram\Database\DatabaseManager;
use LaraGram\Database\Eloquent\Model as Eloquent;
use LaraGram\Support\Traits\CapsuleManagerTrait;
use PDO;
...
class Manager
{
     ...
     *
     * @var \LaraGram\Database\DatabaseManager
     */
    protected $manager;
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|string  $table
     ...
     *
     * @return \LaraGram\Database\DatabaseManager
     */
