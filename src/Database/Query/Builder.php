...
use LaraGram\Contracts\Database\Query\Builder as BuilderContract;
use LaraGram\Contracts\Database\Query\ConditionExpression;
use LaraGram\Contracts\Database\Query\Expression as ExpressionContract;
use LaraGram\Contracts\Support\Arrayable;
use LaraGram\Database\Concerns\BuildsQueries;
use LaraGram\Database\Concerns\BuildsWhereDateClauses;
use LaraGram\Database\Concerns\ExplainsQueries;
...
{
    /** @use \LaraGram\Database\Concerns\BuildsQueries<\stdClass> */
     ...
     *
     * @var \LaraGram\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \LaraGram\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @var array{
     *     function: string,
     *     columns: array<\LaraGram\Contracts\Database\Query\Expression|string>
     * }|null
     */
    public $aggregate;
     ...
     *
     * @var array<string|\LaraGram\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \LaraGram\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \LaraGram\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|literal-string  $expression
     * @param  string  $as
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $column
     * @param  \LaraGram\Support\Collection<int, float>|\LaraGram\Contracts\Support\Arrayable|array<int, float>|string  $vector
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>|\LaraGram\Contracts\Database\Query\Expression|string  $table
     * @param  string|null  $as
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\LaraGram\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\LaraGram\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $table
     * @return \LaraGram\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $table
     * @return \LaraGram\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\LaraGram\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|literal-string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \LaraGram\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\LaraGram\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\LaraGram\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>|\LaraGram\Contracts\Database\Query\Expression|string  $column
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @param  array{\LaraGram\Contracts\Database\Query\Expression|string, \LaraGram\Contracts\Database\Query\Expression|string}  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\LaraGram\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \LaraGram\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>|\LaraGram\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $column
     * @param  \LaraGram\Support\Collection<int, float>|\LaraGram\Contracts\Support\Arrayable|array<int, float>  $vector
     * @return $this
     *
     * @throws \JsonException
     */
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Contracts\Database\Query\Expression|string|null  $column
     * @param  SortDirection|'asc'|'desc'  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\LaraGram\Database\Query\Builder|\LaraGram\Database\Eloquent\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\LaraGram\Contracts\Database\Query\Expression|array<string|\LaraGram\Contracts\Database\Query\Expression>  $columns
     ...
     *
     * @param  string|\LaraGram\Contracts\Database\Query\Expression|array<string|\LaraGram\Contracts\Database\Query\Expression>  $columns
     * @return \LaraGram\Support\Collection<int, \stdClass>
     */
     ...
     *
     * @param  array<string|\LaraGram\Contracts\Database\Query\Expression>  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  array<string|\LaraGram\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\LaraGram\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \LaraGram\Support\LazyCollection<int, \stdClass>
     */
     ...
     * @return \LaraGram\Support\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  string  $function
     * @param  array<\LaraGram\Contracts\Database\Query\Expression|string>  $columns
     * @return $this
     */
     ...
     *
     * @return \LaraGram\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \LaraGram\Database\Query\Grammars\Grammar
     */
