...
{
    /** @use \LaraGram\Database\Concerns\BuildsQueries<object> */
     ...
     * @param  \LaraGram\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \LaraGram\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \LaraGram\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  \LaraGram\Contracts\Database\Query\Expression|string  $table
