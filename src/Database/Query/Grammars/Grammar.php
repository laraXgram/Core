...
namespace LaraGram\Database\Query\Grammars;

use LaraGram\Contracts\Database\Query\Expression;
use LaraGram\Database\Concerns\CompilesJsonPaths;
use LaraGram\Database\Grammar as BaseGrammar;
use LaraGram\Database\Query\Builder;
use LaraGram\Database\Query\JoinClause;
use LaraGram\Database\Query\JoinLateralClause;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \LaraGram\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\LaraGram\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
     ...
     *
     * @param  \LaraGram\Database\Query\JoinLateralClause  $join
    ...
    protected function compileGroupLimit(Builder $query)
    {
        ...
        $table = $this->wrap('laragram_table');
        $row = $this->wrap('laragram_row');
    ...
    protected function compileRowNumber($partition, $orders)
    {
        ...
        return ', row_number() over ('.$over.') as '.$this->wrap('laragram_row');
    }
