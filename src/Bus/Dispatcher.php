...
class Dispatcher implements QueueingDispatcher
{
     ...
     *
     * @var \LaraGram\Pipeline\Pipeline
     */
    protected $pipeline;
     ...
     *
     * @param  \LaraGram\Support\Collection|array|mixed  $jobs
     * @return \LaraGram\Bus\PendingBatch
     */
    public function batch($jobs)
    {
        return new PendingBatch($this->container, is_array($jobs) ? $jobs : ($jobs === null ? [] : [$jobs]));
    }
     ...
     *
     * @param  \LaraGram\Contracts\Queue\Queue  $queue
     * @param  mixed  $command
     * @return mixed
     */
