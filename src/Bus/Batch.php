...
use Closure;
use LaraGram\Bus\Events\BatchCanceled;
use LaraGram\Bus\Events\BatchFinished;
use LaraGram\Bus\Events\BatchStarted;
...
class Batch implements Arrayable, JsonSerializable
{
     ...
     *
     * @var \LaraGram\Tempora\TemporaImmutable
     */
    public $createdAt;
    ...
    public function __construct(
        ...
        ?TemporaImmutable $cancelledAt = null,
        ?TemporaImmutable $finishedAt = null,
    ) {
        $this->queue = $queue;
