...
class RouteCompiler implements RouteCompilerInterface
{
    ...
    private static function compilePattern(BaseRoute $route, string $pattern, bool $isHost): array
    {
        $tokens = [];
        $variables = [];
        $matches = [];
     ...
     */
    private static function determineStaticPrefix(BaseRoute $route, array $tokens): string
    {
        if ('text' !== $tokens[0][0]) {
