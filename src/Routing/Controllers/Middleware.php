...
/**
 * @phpstan-type NextClosure \Closure(\LaraGram\Http\Request): \LaraGram\Http\BaseResponse
 */
class Middleware
{
    /**
     ...
     *
     * @param  (\Closure(\LaraGram\Http\Request, NextClosure): \LaraGram\Http\BaseResponse)|string|array  $middleware
