...
use LaraGram\Routing\Exceptions\RouteNotFoundException;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \LaraGram\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \LaraGram\Routing\RouteCollectionInterface  $routes
    ...
    public function signatureHasNotExpired(Request $request)
    {
        ...
        return ! ($expires && Tempora::now()->getTimestamp() > $expires);
    }
     ...
     * @return string
     *
     * @throws \LaraGram\Routing\Exceptions\RouteNotFoundException|\InvalidArgumentException
     */
     ...
     * @return string
     *
     * @throws \LaraGram\Routing\Exceptions\UrlGenerationException
     */
     ...
     *
     * @return \LaraGram\Routing\RouteUrlGenerator
     */
     ...
     *
     * @param  callable  $keyResolver
     * @return \LaraGram\Routing\UrlGenerator
     */
