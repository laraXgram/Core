...
use LaraGram\Contracts\Routing\BindingRegistrar;
use LaraGram\Contracts\Routing\Registrar as RegistrarContract;
...
use LaraGram\Routing\Events\PreparingResponse;
use LaraGram\Routing\Events\ResponsePrepared;
use LaraGram\Routing\Events\RouteMatched;
use LaraGram\Routing\Events\Routing;
...
use LaraGram\Http\Factory\ResponseInterface as PsrResponseInterface;
use ReflectionClass;
use stdClass;
use LaraGram\Http\Factory\HttpFoundationFactory;
use LaraGram\Http\BaseResponse;

/**
 * @mixin \LaraGram\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \LaraGram\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \LaraGram\Routing\Route|null
     */
    protected $current;
    ...
    {
        return $this->any($uri, '\LaraGram\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\LaraGram\Routing\ViewController')
            ->setDefaults([
                'view' => $view,
                'data' => $data,
     ...
     *
     * @return \LaraGram\Routing\RouteCollectionInterface
     */
