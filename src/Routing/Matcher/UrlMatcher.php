...
class UrlMatcher implements UrlMatcherInterface, RequestMatcherInterface
{
    ...
    public function __construct(
        protected BaseRouteCollection $routes,
     ...
     */
    protected function matchCollection(string $pathinfo, BaseRouteCollection $routes): array
    {
     ...
     */
    protected function getAttributes(BaseRoute $route, string $name, array $attributes): array
    {
     ...
     */
    protected function handleRouteRequirements(string $pathinfo, string $name, BaseRoute $route, array $routeParameters): array
    {
     ...
     * @internal
     */
    protected function createRequest(string $pathinfo): ?BaseRequest
    {
        if (!class_exists(BaseRequest::class)) {
            return null;
        }

        return BaseRequest::create($this->context->getScheme().'://'.$this->context->getHost().$this->context->getBaseUrl().$pathinfo, $this->context->getMethod(), $this->context->getParameters(), [], [], [
