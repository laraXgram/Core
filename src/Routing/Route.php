...
use LaraGram\Routing\Attributes\Controllers\Middleware as MiddlewareAttribute;
use LaraGram\Routing\Contracts\CallableDispatcher;
use LaraGram\Routing\Contracts\ControllerDispatcher as ControllerDispatcherContract;
use LaraGram\Routing\Controllers\HasMiddleware;
use LaraGram\Routing\Controllers\Middleware;
use LaraGram\Routing\Matching\HostValidator;
use LaraGram\Routing\Matching\MethodValidator;
use LaraGram\Routing\Matching\SchemeValidator;
use LaraGram\Routing\Matching\UriValidator;
...
use LaraGram\Routing\BaseRoute;
...
class Route
{
     ...
     *
     * @var \LaraGram\Routing\CompiledRoute
     */
    public $compiled;
    ...
    /**
     * Compile the route into a LaraGram CompiledRoute instance.
     *
     * @return \LaraGram\Routing\CompiledRoute
     */
    protected function compileRoute()
    {
        if (! $this->compiled) {
            $this->compiled = $this->toLaraGramRoute()->compile();
        }
     ...
     *
     * @return \LaraGram\Routing\Contracts\ControllerDispatcher
     *
     * @throws \LaraGram\Contracts\Container\BindingResolutionException
     */
    ...
    /**
     * Convert the route to a LaraGram route.
     *
     * @return \LaraGram\Routing\BaseRoute
     */
    public function toLaraGramRoute()
    {
