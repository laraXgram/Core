...
use LaraGram\Log\Logger\Handler\ErrorLogHandler;
use LaraGram\Log\Logger\Handler\FingersCrossedHandler;
use LaraGram\Log\Logger\Handler\FormattableHandlerInterface;
use LaraGram\Log\Logger\Handler\HandlerInterface;
use LaraGram\Log\Logger\Handler\RotatingFileHandler;
use LaraGram\Log\Logger\Handler\SlackWebhookHandler;
...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param  string  $name
     * @param  \LaraGram\Log\Logger  $logger
     * @return \LaraGram\Log\Logger
     */
    ...
    protected function createEmergencyLogger()
    {
        ...
        $handler = new StreamHandler(
            $config['path'] ?? $this->app->storagePath().'/logs/laragram.log',
     ...
     * @param  array  $config
     * @return \LaraGram\Log\Logger\Handler\HandlerInterface
     */
