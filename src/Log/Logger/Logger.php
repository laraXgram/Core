...
use DateTimeZone;
use Fiber;
use LaraGram\Log\Logger\Handler\HandlerInterface;
use LaraGram\Log\Logger\Processor\ProcessorInterface;
use LaraGram\Log\LoggerInterface;
use LaraGram\Log\Exceptions\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Debug
     */
     ...
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Info
     */
     ...
     * Uncommon events
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Notice
     */
     ...
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Warning
     */
     ...
     * Runtime errors
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Error
     */
     ...
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Critical
     */
     ...
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Alert
     */
     ...
     * Urgent alert.
     *
     * @deprecated Use \LaraGram\Log\Logger\Level::Emergency
     */
    public const EMERGENCY = 600;

    /**
     * LaraGram\Log\Logger API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and LaraGram\Log\Logger ones
     *
     ...
     * there is no performance penalty and LaraGram\Log\Logger 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int                    $level    The logging level (a LaraGram\Log\Logger or RFC 5424 level)
    ...
    public function addRecord(int|Level $level, string $message, array $context = [], JsonSerializableDateTimeImmutable|null $datetime = null): bool
    {
        ...
        try {
            ...
            $record = new LogRecord(
                ...
                channel: $this->name,
                level: self::toLoggerLevel($level),
                message: $message,
                context: $context,
                extra: [],
            );
     ...
     *
     * @deprecated Since 3.0, use {@see toLoggerLevel} or {@see \LaraGram\Log\Logger\Level->getName()} instead
     */
    public static function getLevelName(int|Level $level): string
    {
        return self::toLoggerLevel($level)->getName();
    }

    /**
     * Converts PSR-3 levels to LaraGram\Log\Logger ones if necessary
     *
     * @param  int|string|Level|LogLevel::*      $level Level number (LaraGram\Log\Logger) or name (PSR-3)
     * @throws \Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param value-of<Level::VALUES>|value-of<Level::NAMES>|Level|LogLevel::* $level
     */
    public static function toLoggerLevel(string|int|Level $level): Level
    {
     ...
     *
     * @param mixed             $level   The log level (a LaraGram\Log\Logger, PSR-3 or RFC 5424 level)
    ...
    public function log($level, string|\Stringable $message, array $context = []): void
    {
        if (!$level instanceof Level) {
            ...
            $level = static::toLoggerLevel($level);
        }
