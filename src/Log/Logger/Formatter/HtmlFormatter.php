...
{
    /**
     * Translates LaraGram\Log\Logger log levels to html color priorities.
     */
    ...
    protected function addTitle(string $title, Level $level): string
    {
        ...
        return '<h1 style="background: '.$this->getLevelColor($level).';color: #ffffff;padding: 5px;" class="LaraGram\Log\Logger-output">'.$title.'</h1>';
    }
    ...
    public function format(LogRecord $record): string
    {
        ...
        $output .= '<table cellspacing="1" width="100%" class="LaraGram\Log\Logger-output">';
