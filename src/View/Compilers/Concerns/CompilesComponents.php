...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof LaraGram\View\ComponentAttributeBag ? $attributes->all() : [])); ?>',
    ...
    {
        return "<?php \$attributes ??= new \\LaraGram\\View\\ComponentAttributeBag;

\$__newAttributes = [];
\$__propNames = \LaraGram\View\ComponentAttributeBag::extractPropNames({$expression});
...
\$attributes = new \LaraGram\View\ComponentAttributeBag(\$__newAttributes);
