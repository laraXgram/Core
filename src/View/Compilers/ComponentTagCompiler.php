...
namespace LaraGram\View\Compilers;
...
use LaraGram\View\AnonymousComponent;
use LaraGram\View\DynamicComponent;
use LaraGram\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \LaraGram\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param  \LaraGram\View\Compilers\BladeCompiler|null  $blade
     */
    ...
    protected function componentString(string $component, array $attributes)
    {
        ...
        if (! class_exists($class)) {
            $view = Str::startsWith($component, 'mail::')
                ? "\$__env->getContainer()->make(LaraGram\\View\\Factory::class)->make('{$component}')"
                : "'$class'";
...
<?php if (isset($attributes) && $attributes instanceof LaraGram\View\ComponentAttributeBag): ?>
        ...
        return (new Collection($attributes))
            ->map(function (string $value, string $attribute) use ($escapeBound) {
                return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                    ? "'{$attribute}' => \LaraGram\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                    : "'{$attribute}' => {$value}";
            })
            ->implode(',');
    }
