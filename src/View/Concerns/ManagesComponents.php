...
trait ManagesComponents
{
     ...
     *
     * @param  \LaraGram\Contracts\View\View|\LaraGram\Contracts\Support\Htmlable|\Closure|string  $view
     * @param  array  $data
     * @return void
     */
