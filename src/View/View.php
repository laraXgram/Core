...
class View implements ArrayAccess, Htmlable, Stringable, ViewContract
{
     ...
     *
     * @var \LaraGram\Contracts\View\Engine
     */
    protected $engine;
     ...
     *
     * @param  \LaraGram\View\Factory  $factory
     * @param  \LaraGram\Contracts\View\Engine  $engine
     * @param  string  $view
     * @param  string  $path
     * @param  mixed  $data
     */
