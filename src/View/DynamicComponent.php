...
use LaraGram\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \LaraGram\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \LaraGram\Contracts\View\View|string
     */
...
EOF;
        ...
        return function ($data) use ($template) {
            ...
            return str_replace(
                ...
                [
                    ...
                    $this->compileSlots($data['__laragram_slots']),
                    '{{ $slot ?? "" }}',
                ],
                $template
            );
     ...
     *
     * @return \LaraGram\View\Compilers\ComponentTagCompiler
     */
