...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \LaraGram\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \LaraGram\Session\SessionManager  $manager
     ...
     * @return void
     */
    protected function addCookieToResponse(BaseResponse $response, Session $session)
    {
    ...
    protected function getCookieExpirationDate()
    {
        return $this->manager->getSessionConfig()['expire_on_close']
            ? 0
            : Date::instance(
                Tempora::now()->addSeconds($this->getSessionLifetimeInSeconds())
            );
    }
