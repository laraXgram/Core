...
use LaraGram\Redis\Connectors\PhpRedisConnector;
use LaraGram\Redis\Connectors\PredisConnector;
use LaraGram\Support\Arr;
use LaraGram\Support\ConfigurationUrlParser;
use InvalidArgumentException;

/**
 * @mixin \LaraGram\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @return \LaraGram\Contracts\Redis\Connector|null
     */
