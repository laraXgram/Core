...
use LaraGram\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \LaraGram\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \LaraGram\Redis\Connections\PhpRedisClusterConnection
     */
