...
class CacheTokenRepository implements TokenRepositoryInterface
{
    ...
    public function create(CanResetPasswordContract $user)
    {
        ...
        $this->cache->put(
            $this->cacheKey($user),
            [$this->hasher->make($token), Tempora::now()->format($this->format)],
            $this->expires,
        );
    ...
    {
        return Tempora::createFromFormat($this->format, $createdAt)->addSeconds($this->expires)->isPast();
    }
    ...
    protected function tokenRecentlyCreated($createdAt)
    {
        ...
        return Tempora::createFromFormat($this->format, $createdAt)->addSeconds(
            $this->throttle
        )->isFuture();
    }
