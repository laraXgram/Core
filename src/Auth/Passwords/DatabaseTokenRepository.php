...
class DatabaseTokenRepository implements TokenRepositoryInterface
{
    ...
    {
        return ['email' => $email, 'token' => $this->hasher->make($token), 'created_at' => new Tempora];
    }
    ...
    {
        return Tempora::parse($createdAt)->addSeconds($this->expires)->isPast();
    }
    ...
    protected function tokenRecentlyCreated($createdAt)
    {
        ...
        return Tempora::parse($createdAt)->addSeconds(
            $this->throttle
        )->isFuture();
    }
    ...
    {
        $expiredAt = Tempora::now()->subSeconds($this->expires);
