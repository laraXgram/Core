...
class Vite implements Htmlable
{
     ...
     *
     * @var \LaraGram\Foundation\ViteFonts|null
     */
     ...
     * @return \LaraGram\Support\HtmlString
     *
     * @throws \Exception
     */
     ...
     *
     * @return \LaraGram\Support\HtmlString|void
     */
     ...
     * @return string
     *
     * @throws \LaraGram\Foundation\ViteException
     */
    public function content($asset, $buildDirectory = null)
    {
        ...
        if (! is_file($path) || ! file_exists($path)) {
            throw new \LaraGram\Foundation\ViteException("Unable to locate file from Vite manifest: {$path}.");
        }
     ...
     * @return array
     *
     * @throws \LaraGram\Foundation\ViteManifestNotFoundException
     */
    protected function manifest($buildDirectory)
    {
        ...
        if (! isset(static::$manifests[$path])) {
            if (! is_file($path)) {
                throw new \LaraGram\Foundation\ViteManifestNotFoundException("Vite manifest not found at: $path");
            }
    ...
    protected function chunk($manifest, $file)
    {
        if (! isset($manifest[$file])) {
            throw new \LaraGram\Foundation\ViteException("Unable to locate file in Vite manifest: {$file}.");
        }
     ...
     *
     * @return \LaraGram\Foundation\ViteFonts
     */
    protected function viteFonts()
    {
        return $this->fonts ??= new \LaraGram\Foundation\ViteFonts;
    }
