...
namespace LaraGram\Foundation\Exceptions\Renderer\Mappers;
...
use LaraGram\View\ViewException;
use ReflectionClass;
...
class BladeMapper
{
     ...
     * @param  \LaraGram\View\Compilers\BladeCompiler  $bladeCompiler
     */
     ...
     *
     * @param  \LaraGram\Http\VarDumper\Exceptions\FlattenException  $exception
     * @return \LaraGram\Http\VarDumper\Exceptions\FlattenException
     */
