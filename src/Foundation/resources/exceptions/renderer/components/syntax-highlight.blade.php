...
<div
    ...
    x-init="
        highlightedCode = window.highlight(
            {{ LaraGram\Support\Js::from($code) }},
            {{ LaraGram\Support\Js::from($language) }},
            {{ LaraGram\Support\Js::from($truncate) }},
            {{ LaraGram\Support\Js::from($editor) }},
            {{ LaraGram\Support\Js::from($startingLine) }},
            {{ LaraGram\Support\Js::from($highlightedLine) }}
        );
    "
    {{ $attributes }}
>
