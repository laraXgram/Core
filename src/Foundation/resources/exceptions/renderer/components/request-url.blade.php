...
>
    <div class="flex items-center gap-3 w-full">
        ...
        <x-laragram-exceptions-renderer::http-method method="{{ $request->method() }}" />
        ...
        >
            <x-laragram-exceptions-renderer::icons.copy class="w-3 h-3 text-neutral-400" x-show="!copied" />
            <x-laragram-exceptions-renderer::icons.check class="w-3 h-3 text-emerald-500" x-show="copied" />
        </button>
    </div>
</div>
