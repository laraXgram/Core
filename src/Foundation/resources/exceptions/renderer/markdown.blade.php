...
## Previous {{ \LaraGram\Support\Str::plural('exception', $exception->previousExceptions()->count()) }}
...
{{ $exception->request()->method() }} {{ \LaraGram\Support\Str::start($exception->request()->path(), '/') }}
