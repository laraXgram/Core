...
use LaraGram\Contracts\Validation\Factory as ValidationFactory;
use LaraGram\Contracts\Validation\ValidatesWhenResolved;
use LaraGram\Contracts\Validation\Validator;
use LaraGram\Request\Request;
use LaraGram\Listening\Redirector;
use LaraGram\Validation\ValidatesWhenResolvedTrait;
...
class FormRequest extends Request implements ValidatesWhenResolved
{
    ...
    /**
     * The listen to redirect to if validation fails.
     *
     * @var string
     */
    protected $redirectListen;
     ...
     *
     * @return \LaraGram\Contracts\Validation\Validator
     */
     ...
     *
     * @param  \LaraGram\Contracts\Validation\Factory  $factory
     * @return \LaraGram\Contracts\Validation\Validator
     */
    ...
    protected function getRedirectUrl()
    {
        ...
        } elseif ($this->redirectListen) {
            return $url->listen($this->redirectListen);
