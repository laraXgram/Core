...
use LaraGram\Queue\Jobs\DatabaseJobRecord;
use LaraGram\Queue\Jobs\InspectedJob;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \LaraGram\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string|null  $queue
     * @return \LaraGram\Support\Collection<int, \LaraGram\Queue\Jobs\InspectedJob>
     */
     ...
     *
     * @param  string|null  $queue
     * @return \LaraGram\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     * @param  string  $queue
     * @param  \LaraGram\Queue\Jobs\DatabaseJobRecord  $job
     * @return \LaraGram\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \LaraGram\Queue\Jobs\DatabaseJobRecord  $job
     * @return \LaraGram\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \LaraGram\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
