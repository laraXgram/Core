...
use LaraGram\Queue\Listener;
use LaraGram\Queue\ListenerOptions;
...
class ListenCommand extends Command
{
     ...
     *
     * @param  \LaraGram\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->laragram['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->laragram['config']->get(
     ...
     *
     * @return \LaraGram\Queue\ListenerOptions
     */
