...
class InspectedJob
{
     ...
     * @param  array  $payload
     * @param  \LaraGram\Support\Tempora|null  $createdAt  The date and time the job was created.
     */
    public function __construct(
        ...
        public readonly ?Tempora $createdAt = null,
    ) {
    }
    ...
    public static function fromPayload(string $payload, ?int $attempts = null, ?string $queue = null): static
    {
        ...
        return new static(
            ...
            payload: $decoded,
            createdAt: isset($decoded['createdAt']) ? Tempora::createFromTimestamp($decoded['createdAt']) : null,
        );
    }
}
