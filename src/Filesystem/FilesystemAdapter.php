...
class FilesystemAdapter implements CloudFilesystemContract
{
     ...
     *
     * @var \LaraGram\Contracts\Filesystem\FilesystemOperator
     */
    protected $driver;
     ...
     *
     * @var \LaraGram\Filesystem\FilesystemAdapter
     */
    protected $adapter;
     ...
     *
     * @var \LaraGram\Filesystem\PathPrefixer
     */
    protected $prefixer;
     ...
     *
     * @param  \LaraGram\Contracts\Filesystem\FilesystemOperator  $driver
     * @param  \LaraGram\Filesystem\FilesystemAdapter  $adapter
     * @param  array  $config
     */
    public function __construct(FilesystemOperator $driver, FilesystemAdapterContract $adapter, array $config = [])
    {
        $this->driver = $driver;
     ...
     *
     * @return \LaraGram\Filesystem\FilesystemAdapter
     */
