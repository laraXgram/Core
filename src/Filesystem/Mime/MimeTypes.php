...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/listen-apd+xml' => ['rapd'],
        'application/listen-s-tsid+xml' => ['sls'],
        'application/listen-usd+xml' => ['rusd'],
        ...
        'application/vnd.listen66.link66+xml' => ['link66'],
    ...
    private const REVERSE_MAP = [
        ...
        'link66' => ['application/vnd.listen66.link66+xml'],
        ...
        'rapd' => ['application/listen-apd+xml'],
        ...
        'rusd' => ['application/listen-usd+xml'],
        ...
        'slm' => ['text/slim'],
        'sls' => ['application/listen-s-tsid+xml'],
