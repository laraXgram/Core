...
class ScheduleListCommand extends Command
{
    ...
    {
        $nextDueDate = Tempora::instance(
            (new CronExpression($event->expression))
                ->getNextRunDate(Tempora::now()->setTimezone($event->timezone))
        ...
        $previousDueDate = Tempora::instance(
            (new CronExpression($event->expression))
                ->getPreviousRunDate(Tempora::now()->setTimezone($event->timezone), allowCurrentDate: true)
                ->setTimezone($timezone),
        );

        $now = Tempora::now()->setTimezone($event->timezone);
