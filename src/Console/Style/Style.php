...
use LaraGram\Console\Helper\OutputWrapper;
...
use LaraGram\Console\Helper\TableCell;
use LaraGram\Console\Helper\TableSeparator;
use LaraGram\Console\Input\InputInterface;
use LaraGram\Console\Output\ConsoleOutputInterface;
use LaraGram\Console\Output\ConsoleSectionOutput;
use LaraGram\Console\Output\OutputInterface;
use LaraGram\Console\Output\TrimmedBufferOutput;
...
class Style extends OutputStyle
{
    public const MAX_LINE_LENGTH = 120;

    private LaraGramQuestionHelper $questionHelper;
    ...
    public function askQuestion(Question $question): mixed
    {
        ...
        $this->questionHelper ??= new LaraGramQuestionHelper();
