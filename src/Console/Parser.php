...
class Parser
{
     ...
     * @return array{string, array{}, array{}}|array{string, \LaraGram\Console\Input\InputArgument[], \LaraGram\Console\Input\InputOption[]}
     *
     ...
     *
     * @param  string[]  $tokens
     * @return array{\LaraGram\Console\Input\InputArgument[], \LaraGram\Console\Input\InputOption[]}
     */
     ...
     *
     * @param  string  $token
     * @return \LaraGram\Console\Input\InputArgument
     */
