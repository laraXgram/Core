...
use LaraGram\Validation\Concerns\EmailValidator\Token;
use LaraGram\Validation\Concerns\EmailValidator\EmailLexer;
use LaraGram\Validation\Concerns\EmailValidator\Warning\TLD;
...
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\DotAtEnd;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\DotAtStart;
use LaraGram\Validation\Concerns\EmailValidator\Warning\DeprecatedComment;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\CRLFAtTheEnd;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\LabelTooLong;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\NoDomainPart;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\ConsecutiveAt;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\DomainTooLong;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\CharNotAllowed;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\DomainHyphened;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\ExpectingATEXT;
use LaraGram\Validation\Concerns\EmailValidator\Parser\CommentStrategy\DomainComment;
use LaraGram\Validation\Concerns\EmailValidator\Result\Reason\ExpectingDomainLiteralClose;
use LaraGram\Validation\Concerns\EmailValidator\Parser\DomainLiteral as DomainLiteralParser;
