...
namespace LaraGram\Contracts\Database;
...
class ModelIdentifier
{
     ...
     *
     * @var class-string<\LaraGram\Database\Eloquent\Model>|string|null
     */
    public $class;
     ...
     *
     * @var class-string<\LaraGram\Database\Eloquent\Collection>|null
     */
     ...
     *
     * @param  class-string<\LaraGram\Database\Eloquent\Model>|null  $class
     * @param  mixed  $id
