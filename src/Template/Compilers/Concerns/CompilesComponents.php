...
use LaraGram\Template\ComponentAttributeBag;
...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $component = '.$component.'::resolve('.($data ?: '[]').' + (isset($attributes) && $attributes instanceof LaraGram\Template\ComponentAttributeBag ? $attributes->all() : [])); ?>',
            '<?php $component->withName('.$alias.'); ?>',
            '<?php if ($component->shouldRender()): ?>',
            '<?php $__env->startComponent($component->resolveTemplate(), $component->data()); ?>',
        ]);
    }
    ...
    {
        return "<?php \$attributes ??= new \\LaraGram\\Template\\ComponentAttributeBag;

\$__newAttributes = [];
\$__propNames = \LaraGram\Template\ComponentAttributeBag::extractPropNames({$expression});
...
\$attributes = new \LaraGram\Template\ComponentAttributeBag(\$__newAttributes);
