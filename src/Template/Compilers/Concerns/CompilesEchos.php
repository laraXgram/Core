...
trait CompilesEchos
{
    ...
    /**
     * Compile Temple8 echos into valid PHP.
     *
     * @param  string  $value
     * @return string
     */
    ...
    /**
     * Add an instance of the Temple8 echo handler to the start of the compiled string.
     *
     * @param  string  $result
     * @return string
     */
    protected function addTemple8CompilerVariable($result)
    {
        return "<?php \$__Temple8Compiler = app('temple8.compiler'); ?>".$result;
    }
    ...
    protected function wrapInEchoHandler($value)
    {
        ...
        return empty($this->echoHandlers) ? $value : '$__Temple8Compiler->applyEchoHandler('.$value.')';
    }
