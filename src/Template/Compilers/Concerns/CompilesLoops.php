...
use LaraGram\Contracts\Template\TemplateCompilationException;
...
trait CompilesLoops
{
     ...
     * @return string
     *
     * @throws \LaraGram\Contracts\Template\TemplateCompilationException
     */
    protected function compileForelse($expression)
    {
        ...
        if (count($matches) === 0) {
            throw new TemplateCompilationException('Malformed @forelse statement.');
        }
    ...
    protected function compileForeach($expression)
    {
        ...
        if (count($matches) === 0) {
            throw new TemplateCompilationException('Malformed @foreach statement.');
        }
