 ...
 * @method static \LaraGram\Listening\Listen onReferral(string $pattern, callable|array|string $action)
 ...
 * @method static \LaraGram\Listening\Listen onUrl(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEmail(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPhoneNumber(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onTextLink(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onTextMention(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onCustomEmoji(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSpoiler(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBlockquote(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onExpandableBlockquote(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBold(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onItalic(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onUnderline(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onStrikethrough(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onCode(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPre(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBusinessConnection(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onDeletedBusinessMessages(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBusinessMessage(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBusinessMessageText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEditedBusinessMessage(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEditedBusinessMessageText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGuestMessage(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGuestMessageText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEditedMessageText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChannelPostText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEditedChannelPostText(string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onMessageReaction(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onMessageReactionEmoji(callable|array|string $action, string|array $emoji = 'any')
 * @method static \LaraGram\Listening\Listen onMessageReactionCustomEmoji(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onMessageReactionType(string|array $type, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onMessageReactionCount(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPurchasedPaidMedia(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChatBoost(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onRemovedChatBoost(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onManagedBot(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPollUpdate(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onAlbum(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onInlineQueryQuery(array|string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChosenInlineResultQuery(array|string $pattern, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onStory(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPaidMedia(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onLivePhoto(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChecklist(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChecklistTasksDone(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChecklistTasksAdded(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onBoostAdded(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChatBackgroundSet(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChannelChatCreated(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGift(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onUniqueGift(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGiftUpgradeSent(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onRefundedPayment(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onUsersShared(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChatShared(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onWriteAccessAllowed(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGiveawayCreated(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGiveaway(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGiveawayWinners(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGiveawayCompleted(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGeneralForumTopicHidden(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onGeneralForumTopicUnhidden(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onDirectMessagePriceChanged(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPaidMessagePriceChanged(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPollOptionAdded(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onPollOptionDeleted(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSuggestedPostApproved(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSuggestedPostApprovalFailed(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSuggestedPostDeclined(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSuggestedPostPaid(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSuggestedPostRefunded(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onManagedBotCreated(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChatOwnerLeft(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onChatOwnerChanged(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onRichMessage(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onRichMessageType(string|array $type, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onSubscription(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onCommunityChatAdded(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onCommunityChatRemoved(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onEphemeralMessage(callable|array|string $action)
