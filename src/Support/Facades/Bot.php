...
/**
 * @method static \LaraGram\Listening\Listen on(array|string $message, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onText(array|string $message, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onCommand(array|string $command, callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onAnimation(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onAudio(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onDocument(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onPhoto(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onSticker(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onVideo(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onVideoNote(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onVoice(callable|array|string $action, array|string|null $file_id = null)
 * @method static \LaraGram\Listening\Listen onContact(callable|array|string $action)
 * @method static \LaraGram\Listening\Listen onDice(callable|array|string $action, string|null $emoji = null, string|int|null $value = null)
 ...
 * @method static \LaraGram\Listening\Listen onCallbackQueryData(array|string $pattern, callable|array|string $action)
 ...
 * @method static \LaraGram\Listening\Listen onAny(callable|array|string $action)
