 ...
 *
 * @method static onList(array|string $name, callable|array|string $action)
 * @method static onArray(array $array, callable|array|string $action)
 ...
 * @method static Group middleware(array|string $middlewares)
 * @method static Group withoutMiddleware(array|string $middlewares)
