...
/**
 * @method static \LaraGram\Cache\RateLimiter for(\BackedEnum|\UnitEnum|string $name, \Closure $callback)
 ...
 *
 * @see \LaraGram\Cache\RateLimiter
 */
class RateLimiter extends Facade
{
    ...
    {
        return \LaraGram\Cache\RateLimiter::class;
    }
}
