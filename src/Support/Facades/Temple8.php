 ...
 * @method static string render(string $string, array $data = [], bool $deleteCachedTemplate = false)
 * @method static string renderComponent(\LaraGram\Template\Component $component)
 ...
 * @method static \LaraGram\Template\Compilers\Temple8Compiler prepareStringsForCompilationUsing(callable $callback)
 ...
 *
 * @see \LaraGram\Template\Compilers\Temple8Compiler
 */
class Temple8 extends Facade
{
    /**
