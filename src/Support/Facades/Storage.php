 ...
 * @method static bool put(string $path, \Psr\Http\Message\StreamInterface|string|resource $contents, mixed $options = [])
 * @method static string|false putFileAs(string $path, string|array|null $file, string|array|null $name = null, mixed $options = [])
 ...
 * @method static \LaraGram\Contracts\Filesystem\FilesystemOperator getDriver()
 * @method static \LaraGram\Contracts\Filesystem\FilesystemAdapter getAdapter()
