...
/**
 * @method static \LaraGram\Foundation\Configuration\ApplicationBuilder configure(string|null $basePath = null)
 ...
 * @method static \LaraGram\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \LaraGram\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static string getBootstrapProvidersPath()
 * @method static \LaraGram\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \LaraGram\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \LaraGram\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \LaraGram\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \LaraGram\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \LaraGram\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string templatePath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \LaraGram\Foundation\Application useEnvironmentPath(string $path)
 * @method static \LaraGram\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \LaraGram\Support\ServiceProvider register(\LaraGram\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \LaraGram\Support\ServiceProvider|null getProvider(\LaraGram\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\LaraGram\Support\ServiceProvider|string $provider)
 * @method static \LaraGram\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \LaraGram\Request\Response handleBot(\LaraGram\Request\Request $request, int $type = 1, bool $catch = true)
 * @method static \LaraGram\Http\BaseResponse handleHttp(\LaraGram\Http\BaseRequest $request, int $type = 1, bool $catch = true)
 * @method static void handleRequest(\LaraGram\Request\Request $request)
 * @method static void handleHttpRequest(\LaraGram\Http\Request $request)
 ...
 * @method static bool listensAreCached()
 * @method static string getCachedListensPath()
 * @method static bool eventsAreCached()
 * @method static string getCachedEventsPath()
 * @method static \LaraGram\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \LaraGram\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \LaraGram\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \LaraGram\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \LaraGram\Foundation\Application getInstance()
 * @method static \LaraGram\Contracts\Container\Container|\LaraGram\Foundation\Application setInstance(\LaraGram\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \LaraGram\Foundation\Application
 */
