 ...
 * @method static \LaraGram\Support\Collection dispatched(string $command, callable|null $callback = null)
 * @method static \LaraGram\Support\Collection dispatchedSync(string $command, callable|null $callback = null)
 * @method static \LaraGram\Support\Collection dispatchedAfterResponse(string $command, callable|null $callback = null)
 * @method static \LaraGram\Support\Collection batched(callable $callback)
 ...
 * @method static \LaraGram\Bus\Batch dispatchFakeBatch(string $name = '')
 * @method static \LaraGram\Bus\Batch recordPendingBatch(\LaraGram\Bus\PendingBatch $pendingBatch)
 * @method static \LaraGram\Support\Testing\Fakes\BusFake serializeAndRestore(bool $serializeAndRestore = true)
 * @method static array dispatchedBatches()
 *
 * @see \LaraGram\Bus\Dispatcher
 * @see \LaraGram\Support\Testing\Fakes\BusFake
 */
class Bus extends Facade
{
     ...
     * @return \LaraGram\Support\Testing\Fakes\BusFake
     */
