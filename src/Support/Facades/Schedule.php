 ...
 * @method static \LaraGram\Console\Scheduling\Event command(\LaraGram\Console\Command\Command|string $command, array $parameters = [])
 * @method static \LaraGram\Console\Scheduling\CallbackEvent job(object|string $job, \UnitEnum|string|null $queue = null, \UnitEnum|string|null $connection = null)
 ...
 * @method static \LaraGram\Console\Scheduling\Event[] eventsForEnvironments(array $environments)
 * @method static \LaraGram\Console\Scheduling\Schedule useCache(\UnitEnum|string $store)
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes withoutOverlapping(int $expiresAt = 1440, bool $releaseOnTerminationSignals = true)
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes environments(mixed $environments)
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes evenInMaintenanceMode()
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes evenWhenPaused()
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes withAttributes(array $attributes)
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes weeklyOn(mixed $dayOfWeek, string $time = '0:0')
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes daysOfMonth(array|int ...$days)
 ...
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes days(mixed $days)
 * @method static \LaraGram\Console\Scheduling\PendingEventAttributes timezone(\UnitEnum|\DateTimeZone|string $timezone)
 *
