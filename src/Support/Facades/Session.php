 ...
 * @method static \LaraGram\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \LaraGram\Contracts\Container\Container getContainer()
 * @method static \LaraGram\Session\SessionManager setContainer(\LaraGram\Contracts\Container\Container $container)
 * @method static \LaraGram\Session\SessionManager forgetDrivers()
 ...
 * @method static \LaraGram\Contracts\Cache\Repository cache()
 ...
 * @method static \LaraGram\Support\Uri previousUri()
 ...
 * @method static void setRequestOnHandler(\LaraGram\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \LaraGram\Session\SessionManager
 */
