...
/**
 * @method static \LaraGram\Redis\Connections\Connection connection(string|null $name = null)
 * @method static \LaraGram\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \LaraGram\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \LaraGram\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \LaraGram\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \LaraGram\Redis\Connections\Connection setName(string $name)
 ...
 *
 * @see \LaraGram\Redis\RedisManager
 */
