 ...
 * @method static \LaraGram\Auth\Access\Gate resource(string $name, string $class, array|null $abilities = null)
 ...
 * @method static \LaraGram\Auth\Access\Response authorize(\UnitEnum|string $ability, mixed $arguments = [])
 * @method static \LaraGram\Auth\Access\Response inspect(\UnitEnum|string $ability, mixed $arguments = [])
