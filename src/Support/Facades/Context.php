 ...
 * @method static \LaraGram\Log\Context\Repository increment(string $key, int $amount = 1)
 * @method static \LaraGram\Log\Context\Repository decrement(string $key, int $amount = 1)
