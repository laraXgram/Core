 ...
 * @method static \LaraGram\Console\Scheduling\Schedule resolveConsoleSchedule()
 ...
 * @method static \LaraGram\Foundation\Bus\PendingDispatch queue(string $command, array $parameters = [])
