...
class Inflector
{
    ...
    /**
     * Converts a word into the format for a LaraGram\Support\String table name. Converts 'ModelName' to 'model_name'.
     */
    ...
    /**
     * Converts a word into the format for a LaraGram\Support\String class name. Converts 'table_name' to 'TableName'.
     */
