...
use LaraGram\Support\Env\Util\Error;
...
final class EntryParser
{
     ...
     * @param string $line
     *
     * @return \LaraGram\Support\Env\Util\Result<array{string, string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        if ($result[0] === '') {
            /** @var \LaraGram\Support\Env\Util\Result<array{string, string|null},string> */
     ...
     * @param string $value
     *
     * @return \LaraGram\Support\Env\Util\Result<\LaraGram\Support\Env\Parser\Value, string>
     */
    private static function parseValue(string $value)
    {
        if (\trim($value) === '') {
            /** @var \LaraGram\Support\Env\Util\Result<\LaraGram\Support\Env\Parser\Value, string> */
     ...
     * @param string $token
     *
     * @return \LaraGram\Support\Env\Util\Result<array{string, bool, int}, string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \LaraGram\Support\Env\Util\Result<array{string, bool, int}, string> */
