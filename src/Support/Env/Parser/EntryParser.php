...
final class EntryParser
{
     ...
     * @param string $value
     *
     * @return \GrahamCampbell\ResultType\Result<\LaraGram\Support\Env\Parser\Value, string>
     */
    private static function parseValue(string $value)
    {
        if (\trim($value) === '') {
            /** @var \GrahamCampbell\ResultType\Result<\LaraGram\Support\Env\Parser\Value, string> */
