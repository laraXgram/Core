...
class EncodedHtmlString extends HtmlString
{
     ...
     * The HTML string.
     *
     * @var \LaraGram\Contracts\Support\DeferringDisplayableValue|\LaraGram\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null
     */
    protected $html;
     ...
     *
     * @param  \LaraGram\Contracts\Support\DeferringDisplayableValue|\LaraGram\Contracts\Support\Htmlable|\BackedEnum|string|int|float|null  $html
