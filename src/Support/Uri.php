...
class Uri implements Htmlable, JsonSerializable, Responsable, Stringable
{
    ...
    {
        $this->uri = $uri instanceof UriInterface ? $uri : BaseUri::new((string) $uri);
    }
     ...
     *
     * @return \LaraGram\Support\Stringable
     */
